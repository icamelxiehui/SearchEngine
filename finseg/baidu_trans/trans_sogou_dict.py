...
def deal(file_name):  
    ...
    if data[0:12] !="\x40\x15\x00\x00\x44\x43\x53\x01\x01\x00\x00\x00":  
        print "确认你选择的是搜狗(.scel)词库?",file_name
        #sys.exit(0)  
    #pdb.set_trace()  
...
if __name__ == '__main__':  
    ...
    o = [
	#'股票词汇大全.scel',
#    '经济 金融类词汇.scel','股票词汇大全.scel','股票基金.scel','股票基金词库大全.scel','金融词库.scel','财经金融词汇大全【官方推荐】.scel','2016新增股票名称.scel',
#    '经济 财政 金融 证券 货币 商品 市场 外汇_-.scel','证券专业词库.scel',
'a.bdict',
    ]  
